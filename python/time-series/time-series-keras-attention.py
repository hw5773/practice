...
print ("encoder_stack_h: {}".format(encoder_stack_h))
print ("encoder_last_h: {}".format(encoder_last_h))
...
print ("decoder_stack_h: {}".format(decoder_stack_h))
...
print ("decoder_combined_context: {}".format(decoder_combined_context))
...
model.save('model_forecasting_attention.h5')
